<template>
  <div class="flex-container" id="login" :style="{height: screenHeight+'px'}">
    ...
    <div class="neew">
      <span style="font-size: 77px; text-indent: 0.01px; box-sizing: border-box; color: #FFBC3B;;"  class="colorSelect">FOUND</span></div>
    <div class="hir"></div>
