<template>
  <div class="bok">
    <div class="left"><router-link to="ques" style="text-decoration: none;color:#ffe305;line-height: 570px;"><i class="el-icon-back"></i> </router-link></div>
    <div class="in">
      <div class="inner">
        ...
        <el-form :label-position="labelPosition" label-width="80px" :model="ruleForm" :rules="rules">
          ...
          <el-button type="submit" @click="updateNum">提交</el-button>
        </el-form></div></div>
    <div class="right"></div>
  </div>
</template>
